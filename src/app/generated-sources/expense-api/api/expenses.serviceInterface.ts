...
export interface ExpensesServiceInterface {
     ...
     */
    getExpenses(pageSize: number, pageNumber: number, sortDirection: 'ASC' | 'DESC', sortBy: 'DATE' | 'AMOUNT', tagFilters?: Array<string>, descriptionFilter?: string, paidWithCreditCardFilter?: boolean, creditCardStatementIssuedFilter?: boolean, extraHttpRequestParams?: any): Observable<ExpenseListResponse>;
     ...
     */
    registerExpense(expenseRequest: ExpenseRequest, extraHttpRequestParams?: any): Observable<ExpenseResponse>;
